...
import DebitAccount from "../forms_bank/DebitAccountR";
  ...
  return (
    <div className={classes.root}>
      <Accordion>
        ...
        <CreditAccount bankOne={bankOne} bankTwo={bankTwo} setAll={setAll} />
        <DebitAccount bankOne={bankOne} bankTwo={bankTwo} setAll={setAll} />
        </Box>
