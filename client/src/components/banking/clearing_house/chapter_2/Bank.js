...
export default function BankComponent({ bankDisplay, bank, setAll }) {
  ...
  return (
    <div className={classes.root}>
      <Accordion>
        ...
        <NetAccounts bank={bank} setAll={setAll}/>
        <TotalAccounts bank={bank} setAll={setAll}/>
        </Box>
