...
export default function BankComponent({ bankDisplay, bank, withdrawCash }) {
  ...
  const reserveDepositsTotal = bankDisplay.assets.reserveDeposits.reduce(
    (x, y) => {
      return { amount: x.amount + y.amount };
    },
    { amount: 0 }
  ...
  const cashInputError = cashAmount == 0;
  return (
        ...
        <AccordionDetails>
          <Grid container spacing={3}>
            ...
            >
              ...
              {bankDisplay.assets.reserveDeposits.map(
                (reserveDeposit, index) => {
                  return (
                    <div key={index}>
                      <Typography
                        align="left"
                      ...
                      >
                        Bank {reserveDeposit.bankId}: £{reserveDeposit.amount}
                      </Typography>
                    </div>
                  );
                }
                ...
                return (
                  <div key={index}>
                    <Typography
                      ...
                      style={{ marginLeft: "10px", fontStyle: "italic" }}
                    >
                      Customer {deposit.id}: £{deposit.amount}
                    </Typography>
                  </div>
                );
              })}
            ...
            <Grid
              ...
              style={{ padding: "5px" }}
            >
              <Typography>Total: £{depositsTotal.amount.toFixed(2)}</Typography>
            </Grid>
            <CashWithdraw
