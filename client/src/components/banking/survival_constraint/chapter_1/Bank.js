    ...
    <div className={classes.root}>
      <Accordion >
        ...
        >
          ...
          <div className={classes.columnTwo}>
            <Typography className={classes.secondaryHeading} align="right">
              Assets: {insolvent ? `Insolvent`:`£${(overdraftsTotal.amount + loansTotal.amount + bankDisplay.assets.reserves).toFixed(2)}`}
            </Typography>
            <Typography className={classes.secondaryHeading} align="right">
        ...
        >
          ...
          <Typography className={classes.secondaryHeading} align="left">Overdrafts:</Typography>
          {bankDisplay.assets.overdrafts && bankDisplay.assets.overdrafts.map((overdraft, index) => {
            return (
              <div key={index}>
                <Typography align="left" className={classes.secondaryHeading} style={{marginLeft: "10px", fontStyle: "italic"}}>
                  Customer {overdraft.customerId}: £{overdraft.amount}
                </Typography>
              </div>
            );
          })}
        ...
        {insolvent ? `Insolvent`: `Total: £${(overdraftsTotal.amount + loansTotal.amount + bankDisplay.assets.reserves).toFixed(2)}`}
          </Typography></Grid>
